...
export const Creative4Template: React.FC<{ content: ResumeContent; design: DesignSettings }> = ({ content, design }) => {
  ...
  return (
    <div style={{ fontFamily: design.font, fontSize: `${design.fontSize}px`, lineHeight: design.lineHeight, color: '#1a1a1a', backgroundColor: '#fff', minHeight: '297mm', padding: `${design.margins}mm` }}>
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '24px' }}>
        <div style={{ backgroundColor: design.accentColor, color: '#fff', padding: '24px' }}>
          <div style={{ width: '100px', height: '100px', borderRadius: '50%', backgroundColor: 'rgba(255,255,255,0.2)', margin: '0 auto 16px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: `${design.headingSize + 10}px`, fontWeight: 800 }}>
          ...
          {personalInfo.professionalTitle && <p style={{ fontSize: `${design.fontSize}px`, opacity: 0.9, marginTop: '4px', textAlign: 'center' }}>{personalInfo.professionalTitle}</p>}

          <div style={{ marginTop: '24px' }}>
            <h3 style={{ fontSize: `${design.fontSize}px`, fontWeight: 700, marginBottom: '8px', borderBottom: '1px solid rgba(255,255,255,0.3)', paddingBottom: '4px' }}>Contact</h3>
          ...
          {skills.length > 0 && (
            <div style={{ marginTop: '24px' }}>
              <h3 style={{ fontSize: `${design.fontSize}px`, fontWeight: 700, marginBottom: '8px', borderBottom: '1px solid rgba(255,255,255,0.3)', paddingBottom: '4px' }}>Skills</h3>
              {skills.map((g) => (
          ...
          {languages.length > 0 && (
            <div style={{ marginTop: '24px' }}>
              <h3 style={{ fontSize: `${design.fontSize}px`, fontWeight: 700, marginBottom: '8px', borderBottom: '1px solid rgba(255,255,255,0.3)', paddingBottom: '4px' }}>Languages</h3>
        ...
        <div>
          {summary && <section style={{ marginBottom: '20px' }}><h2 style={{ fontSize: `${design.headingSize}px`, fontWeight: 700, color: design.accentColor, marginBottom: '8px' }}>Profile</h2><p style={{ whiteSpace: 'pre-line', color: '#374151' }}>{summary}</p></section>}
