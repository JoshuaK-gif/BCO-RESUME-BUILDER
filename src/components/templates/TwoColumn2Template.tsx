...
export const TwoColumn2Template: React.FC<{ content: ResumeContent; design: DesignSettings }> = ({ content, design }) => {
  ...
  return (
    <div style={{ fontFamily: design.font, fontSize: `${design.fontSize}px`, lineHeight: design.lineHeight, color: '#1a1a1a', backgroundColor: '#fff', minHeight: '297mm', padding: `${design.margins}mm` }}>
      ...
      {personalInfo.professionalTitle && <p style={{ fontSize: `${design.fontSize + 2}px`, color: design.accentColor, marginTop: '4px', textAlign: 'center' }}>{personalInfo.professionalTitle}</p>}
      ...
      <div style={{ display: 'flex', gap: '24px', marginTop: '20px' }}>
        ...
        <div style={{ flex: 1, backgroundColor: '#f8f9fa', padding: '16px', borderRadius: '8px' }}>
          {skills.length > 0 && (
            <section style={{ marginBottom: '16px' }}>
